...
https://doi.org/10.1016/S0378-3812(97)00145-3
"""
...
function dielectric_constant(model::ZuoFurstModel,V,T,z,_data=nothing)
    ...
    return -19.2905+29814.5/T-0.019678*T+1.318e-4*T^2-3.1144e-7*T^3 # Water

    # return 1.0*10^(1.514-0.00264*(T-298.15)) # MMMethanol

    # return (175.72) - (3.0699)/T - (0.35350)*T - (0.20285e-2)*T^2 + (0.50644e-5)*T^3 # EEEthanol
